...
class DatingUserTemplates {
  ...
  createVerificationTemplate(email, token, firstName) {
    ...
    const expiryTime = this.config.formatExpiryTime(
      this.config.EXPIRY_TIMES.VERIFICATION,
    );
    ...
    const html = `
      ...
      <body>
        <div class="container">
          <div class="header">
            <h1>Welcome to JWLovers</h1>
          </div>
          <div class="content">
            <h2>Hi ${firstName || "there"}! 👋</h2>
            <p>Thanks for joining our community! We're excited to have you here.</p>
            <p>To complete your registration and start connecting, please verify your email address by clicking the button below:</p>
          ...
          <div class="footer">
            ...
            <p>&copy; ${new Date().getFullYear()} JWLovers. All rights reserved.</p>
          </div>
        </div>
      </body>
      </html>
  ...
  createWelcomeTemplate(email, firstName) {
        ...
        <div class="container">
          ...
          <div class="content">
            <div class="success-notice">
              <strong>Email Verified!</strong> Your registration is now complete.
            </div>
            
            <h2>Welcome aboard, ${firstName}!</h2>
            <p>Your email has been successfully verified and your account dashboard is active.</p>
            
            <div class="tip-box">
              <strong>Quick Tips to Get Started:</strong>
              <ul>
                <li>Complete your profile setup to get started</li>
                <li>Add high-quality photos to your account</li>
                <li>Write a brief intro bio text</li>
              </ul>
            </div>
            ...
            <p>If you have any questions or require assistance, please visit our help documentation page.</p>
    ...
    const text = `Account Verified!\n\nHi ${firstName},\n\nYour account verification is complete and your registration is active.\n\nNext Steps:\n1. Complete your profile setup: ${profileUrl}\n2. Visit your account dashboard: ${loginUrl}\n\nThank you for completing your registration.\n\nBest regards,\nThe JWLovers Team`;
